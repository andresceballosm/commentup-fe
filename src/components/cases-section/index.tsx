...
const articles = [
  {
    title: 'Listen your followers.',
    image: '/images/case-1.webp',
    alt: 'Proident pariatur est.',
  },
  {
    title: 'Analyze your acceptance.',
  ...
  <section>
    <div className={tw('w-full min-h-screen bg-gray-900 relative')}>
      ...
      <div className={tw('max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40')}>
        <h1 className={tw('text-white text-4xl lg:text-7xl font-bold text-center')}>Closer to your followers</h1>
        <p className={tw('text-white text-gray-400 text-center text-xl mt-12')}>
          Everything you need to stay in touch with your followers in one place
        </p>
