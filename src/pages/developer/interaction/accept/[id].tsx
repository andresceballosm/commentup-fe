        ...
        <CardBox className="w-11/12 md:w-7/12 lg:w-8/12 xl:w-6/12 shadow-2xl" footer={null}>
          <div className="space-y-3">
            ...
            <h1 className="text-2xl text-indigo-400">
              🚀Congratulations, we&apos;ve notified to the client about your interest in the position!
            </h1>
            <p>
              Once the client confirms their availability for an interview 📅, we will promptly notify you via email.
              You will receive detailed instructions on how to select a suitable schedule for the interview. Please
              ensure to check your email regularly for further updates and communications regarding the interview
              process.
            </p>
          </div>
        </CardBox>
