  ...
  return (
    <>
      ...
      <SectionMain>
        ...
        {success || (error && <ToastComponent text={success || error} />)}

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="">
            <CardBox className="mb-6">
              <FormField label="Avatar" help="">
                  ...
                  <CardBoxComponentBody>
                    <div className="grid gap-4 md:grid-cols-2 xs:grid-cols-1">
                      ...
                      <FormField label="Company" help="">
                        <Field name="company" id="company" required />
                      </FormField>
          ...
          <CardBox hasComponentLayout>
            <h5 className="p-5 text-xl font-bold leading-none text-gray-900 dark:text-white">Payment Methods</h5>
            <CardBox>
...
ProfilePage.Auth = WithPrivateRouteClient;
